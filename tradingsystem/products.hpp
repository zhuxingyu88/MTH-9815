...
string IRSwap::ToString(FloatingIndex _floatingIndex) const
{
  switch (_floatingIndex) {
...
string IRSwap::ToString(FloatingIndexTenor _floatingIndexTenor) const
{ 
  switch(_floatingIndexTenor) {
...
string IRSwap::ToString(Currency _currency) const
{ 
  switch(_currency) {
  case USD: return "USD";
  case EUR: return "EUR";
...
string IRSwap::ToString(SwapType _swapType) const
{ 
  switch(_swapType) {
...
string IRSwap::ToString(SwapLegType _swapLegType) const
{ 
  switch(_swapLegType) {
